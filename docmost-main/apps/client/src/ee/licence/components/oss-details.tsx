    ...
    <Stack gap="lg">
      ...
      <Stack gap="md">
        ...
        <Text size="sm" c="dimmed">
          Get an enterprise trial key at <a href="https://customers.hehestl.com/" target="_blank" rel="noopener noreferrer">customers.hehestl.com</a>.
        </Text>

        <Text size="sm" c="dimmed">
          Visit <a href="https://hehestl.com/pricing" target="_blank" rel="noopener noreferrer">hehestl.com/pricing</a> to purchase an enterprise license.
        </Text>
      </Stack>
    </Stack>
  );
