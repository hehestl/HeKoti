    ...
    <Stack gap="lg">
      {!hasAccess && (
        <Alert icon={<IconInfoCircle />} title={upgradeLabel} color="blue">
          {t(
            "MCP is only available in the hehestl enterprise edition. Contact sales@hehestl.com.",
          )}
        </Alert>
      )}
        ...
        <div>
          ...
          <Text size="sm" c="dimmed">
            ...
            <Trans
              ...
              components={{
                anchor: <Anchor href="https://hehestl.com/docs/user-guide/mcp" target="_blank" size="sm" />,
              }}
            />
          </Text>
        </div>
