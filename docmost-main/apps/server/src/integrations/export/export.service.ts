...
import { Page } from '@hehestl/db/types/entity.types';
...
import { htmlToMarkdown } from '@hehestl/editor-ext';
...
export class ExportService {
  ...
  async zipPages(
    ...
    zip.file('hehestl-metadata.json', JSON.stringify(metadata, null, 2));
  }
