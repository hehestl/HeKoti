...
export class EnvironmentService {
  ...
  getMailFromName(): string {
    return this.configService.get<string>('MAIL_FROM_NAME', 'hehestl');
  }
  ...
  /** JSON string: `[{ "title": "...", "items": [{ "label": "...", "url": "https://..." }] }]` */
  getHeaderNavMenus(): string {
    return this.configService.get<string>('HEADER_NAV_MENUS');
  }
