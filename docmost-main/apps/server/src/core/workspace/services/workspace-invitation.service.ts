...
import {
  ...
  Workspace,
  WorkspaceInvitation,
} from '@hehestl/db/types/entity.types';
import { MailService } from '../../../integrations/mail/mail.service';
import InvitationEmail from '@hehestl/transactional/emails/invitation-email';
import { GroupUserRepo } from '@hehestl/db/repos/group/group-user.repo';
import InvitationAcceptedEmail from '@hehestl/transactional/emails/invitation-accepted-email';
import { TokenService } from '../../auth/services/token.service';
import { SessionService } from '../../session/session.service';
import { nanoIdGen } from '../../../common/helpers';
import { PaginationOptions } from '@hehestl/db/pagination/pagination-options';
import { executeWithCursorPagination } from '@hehestl/db/pagination/cursor-pagination';
...
export class WorkspaceInvitationService {
  ...
  async acceptInvitation(
    ...
    if (invitedByUser) {
      ...
      await this.mailService.sendToQueue({
        ...
        subject: `${newUser.name} has accepted your hehestl invite`,
  ...
  async sendInvitationMail(
    ...
    await this.mailService.sendToQueue({
      to: inviteeEmail,
      subject: `${invitedByName} invited you to hehestl`,
      template: emailTemplate,
    });
  }
}
