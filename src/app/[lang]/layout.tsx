...
import { getMascotId } from "@/lib/site-config";
import { resolveMascotSrc } from "@/lib/mascots";
...
export default async function LocaleLayout({
  ...
  const mascotSrc = resolveMascotSrc(await getMascotId());

  return (
    <MascotProvider src={mascotSrc}>
