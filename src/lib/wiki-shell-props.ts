...
export async function getWikiShellProps(inputLang: string) {
  ...
  return {
    ...
    codeCopyLabel: dict.article.codeCopy,
    codeCopiedLabel: dict.article.codeCopied,
    homeInlineEditLabels: {
      ...
      clearIcon: dict.home.inlineEdit.clearIcon,
      moveUp: dict.home.inlineEdit.moveUp,
      moveDown: dict.home.inlineEdit.moveDown,
      changeIcon: dict.home.inlineEdit.changeIcon,
      dropReorder: dict.home.inlineEdit.dropReorder,
      dropNest: dict.home.inlineEdit.dropNest,
      dropRoot: dict.home.inlineEdit.dropRoot,
      moveBlocked: dict.home.inlineEdit.moveBlocked,
      descriptionLabel: dict.home.inlineEdit.descriptionLabel,
      descriptionPlaceholder: dict.home.inlineEdit.descriptionPlaceholder,
      save: dict.admin.workbench.inlineEditSave,
      cancel: dict.admin.workbench.inlineEditCancel,
      saved: dict.admin.workbench.inlineEditSaved,
      saving: dict.admin.workbench.inlineEditSaving,
